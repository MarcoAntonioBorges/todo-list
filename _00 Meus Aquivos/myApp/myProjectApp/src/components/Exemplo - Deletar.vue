<template>
  ...
  <div class="contain">
    <categoria v-for="categoria in categorias" v-bind:titulo="categoria.titulo" v-bind:key="categoria.id" v-bind:filmes="categoria.filmes"></categoria>
  </div>
...
.row__inner:hover .gui-card:first-child:hover{
  transition: all 1s;
  -webkit-transform: scale(1.5);
  transform        : scale(1.5);
  opacity          : 1;
